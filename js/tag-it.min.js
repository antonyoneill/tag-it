...
c.val("");b.each(g,function(b,c){a.createTag(c,null,!0);d=!0})}else this.options.singleFieldNode=b('<input type="hidden" style="display:none;" value="" name="'+this.options.fieldName+'" />'),this.tagList.after(this.options.singleFieldNode);d||this.tagList.children("li").each(function(){b(this).hasClass("tagit-new")||(a.createTag(b(this).text(),b(this).attr("class"),!0),b(this).remove())});var f=function(c){var d=c.keyCode||c.which;if(navigator.userAgent.match(/Android|iPad/i)){var e=this.value;if(0==
d||229==d)d=e.charCodeAt(e.length-1)}if(d===b.ui.keyCode.COMMA&&!1===c.shiftKey||d===b.ui.keyCode.ENTER||d==b.ui.keyCode.TAB&&""!==a.tagInput.val()||d==b.ui.keyCode.SPACE&&!0!==a.options.allowSpaces&&('"'!=b.trim(a.tagInput.val()).replace(/^s*/,"").charAt(0)||'"'==b.trim(a.tagInput.val()).charAt(0)&&'"'==b.trim(a.tagInput.val()).charAt(b.trim(a.tagInput.val()).length-1)&&0!==b.trim(a.tagInput.val()).length-1))d===b.ui.keyCode.ENTER&&""===a.tagInput.val()||c.preventDefault(),a.options.autocomplete.autoFocus&&
a.tagInput.data("autocomplete-open")||(a.tagInput.autocomplete("close"),a.createTag(a._cleanedInput()))};this.tagInput.keyup(f).keydown(function(c){if(c.which==b.ui.keyCode.BACKSPACE&&""===a.tagInput.val()){var d=a._lastTag();!a.options.removeConfirmation||d.hasClass("remove")?a.removeTag(d):a.options.removeConfirmation&&d.addClass("remove ui-state-highlight")}else a.options.removeConfirmation&&a._lastTag().removeClass("remove ui-state-highlight");(c.keyCode||c.which||c.charCode||0)===b.ui.keyCode.ENTER&&
...
assignedTags:function(){var a=this,d=[];this.options.singleField?(d=b(this.options.singleFieldNode).val().split(this.options.singleFieldDelimiter),""===d[0]&&(d=[])):this._tags().each(function(){d.push(a.tagLabel(this))});return d},_updateSingleTagsField:function(a){b(this.options.singleFieldNode).val(a.join(this.options.singleFieldDelimiter)).trigger("change")},_subtractArray:function(a,d){for(var c=[],g=0;g<a.length;g++)-1==b.inArray(a[g],d)&&c.push(a[g]);return c},tagLabel:function(a){return this.options.singleField?
...
b.effects.effect[a]))},createTag:function(a,d,c){var g=this;a=b.trim(a);this.options.preprocessTag&&(a=this.options.preprocessTag(a));if(""===a)return!1;if(!this.options.allowDuplicates&&!this._isNew(a))return a=this._findTagByLabel(a),!1!==this._trigger("onTagExists",null,{existingTag:a,duringInitialization:c})&&this._effectExists("highlight")&&a.effect("highlight"),!1;if(this.options.tagLimit&&this._tags().length>=this.options.tagLimit)return this._trigger("onTagLimitExceeded",null,{duringInitialization:c}),
...
this.options.singleField||(f=f.html(),e.append('<input type="hidden" value="'+f+'" name="'+this.options.fieldName+'" class="tagit-hidden-field" />'));!1!==this._trigger("beforeTagAdded",null,{tag:e,tagLabel:this.tagLabel(e),duringInitialization:c,countOfTags:this._tags().length,tagInstance:this})&&(this.options.singleField&&(f=this.assignedTags(),f.push(a),this._updateSingleTagsField(f)),this._trigger("onTagAdded",null,e),this.tagInput.val(""),this.tagInput.parent().before(e),this._trigger("afterTagAdded",
null,{tag:e,tagLabel:this.tagLabel(e),duringInitialization:c,countOfTags:this._tags().length,tagInstance:this}),this.options.showAutocompleteOnFocus&&!c&&setTimeout(function(){g._showAutocomplete()},0))},removeTag:function(a,d){d="undefined"===typeof d?this.options.animate:d;a=b(a);this._trigger("onTagRemoved",null,a);if(!1!==this._trigger("beforeTagRemoved",null,{tag:a,tagLabel:this.tagLabel(a),countOfTags:this._tags().length,tagInstance:this})){if(this.options.singleField){var c=this.assignedTags(),
g=this.tagLabel(a),c=b.grep(c,function(a){return a!=g});this._updateSingleTagsField(c)}if(d){a.addClass("removed");var c=this._effectExists("blind")?["blind",{direction:"horizontal"},"fast"]:["fast"],f=this;c.push(function(){a.remove();f._trigger("afterTagRemoved",null,{tag:a,tagLabel:f.tagLabel(a),countOfTags:f._tags().length,tagInstance:this})});a.fadeOut("fast").hide.apply(a,c).dequeue()}else a.remove(),this._trigger("afterTagRemoved",null,{tag:a,tagLabel:this.tagLabel(a),countOfTags:this._tags().length,
